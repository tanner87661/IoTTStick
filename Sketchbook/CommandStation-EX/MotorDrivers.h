...
#define EX8874_SHIELD F("EX8874"),\
 new MotorDriver(25/* 3*/, 19/*12*/, UNUSED_PIN, 13/*9*/, 35/*A2*/, 1.27, 5000, 36 /*A4*/), \https://www.msn.com/en-us/tv/news/crabgrass-by-tauhid-bondia/ss-AA1kpJ9z?cvid=209b622c8a624927a211880ca44c9c09
...
#define STANDARD_MOTOR_SHIELD F("STANDARD_MOTOR_SHIELD"),                                                 \
                              ...
                              new MotorDriver( 3, 12, UNUSED_PIN, 9, A2, 8.31, 3000, UNUSED_PIN), \
                              new MotorDriver( 2, 10, UNUSED_PIN, 7, A0, 8.31, 3000, UNUSED_PIN), \
                              new MotorDriver( 5,  4, UNUSED_PIN, 6, A5, 8.31, 3000, UNUSED_PIN)
...
#define STANDARD_MOTOR_SHIELD F("STANDARD_MOTOR_SHIELD"),                                                 \
                              ...
                              new MotorDriver(-11,  7, UNUSED_PIN, -13,  A1, 8.31, 5000, UNUSED_PIN), \
                              new MotorDriver(-12,  8, UNUSED_PIN,  -2,  A2, 8.31, 5000, UNUSED_PIN), \
                              new MotorDriver(-47,  9, UNUSED_PIN,  -3,  A3, 8.31, 5000, UNUSED_PIN), \
                              new MotorDriver(-48, 49, UNUSED_PIN,  -5,  A4, 8.31, 5000, UNUSED_PIN), \
                              new MotorDriver(-42, 43, UNUSED_PIN, -44,  A5, 8.31, 5000, UNUSED_PIN), \
                              new MotorDriver(-40, 41, UNUSED_PIN, -45, A14, 8.31, 5000, UNUSED_PIN), \
                              new MotorDriver(-38, 39, UNUSED_PIN, -46, A15, 8.31, 5000, UNUSED_PIN)
*/
