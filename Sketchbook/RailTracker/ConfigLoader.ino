...
bool openJSONFile(String fileName)
{
  String introSeq = "{\"Header\" : \"" + fileName + "\",\"TrackPoints\" : [";
  return writeJSONFile(fileName, introSeq.c_str());
}

bool appendJSONFile(String fileName, const char * fileStr)
{
...
bool closeJSONFile(String fileName)
{
  String endSeq = "{\"Coord\":[0]}]}";
  return appendJSONFile(fileName, endSeq.c_str());  
}
