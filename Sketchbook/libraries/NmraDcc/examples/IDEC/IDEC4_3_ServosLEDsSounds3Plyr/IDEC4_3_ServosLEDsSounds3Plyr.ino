// Switched  Servos, LEDs Sounds to 3 Sound Players Variable Slow Servvo Travel   IDEC4_3_ServosLEDsSounds3Plyr.ino
...
SoftwareSerial DFSerial2(22,14); // PRO MINI RX, PRO MINI TX serial to DFPlayer
SoftwareSerial DFSerial3(22,17); // PRO MINI RX, PRO MINI TX serial to DFPlayer
...
#define servo_master_slowdown  20   //servo loop counter limit
...
//  {CV_29_CONFIG, CV29_EXT_ADDRESSING | CV29_F0_LOCATION},   // Long  Address 28/128 Speed Steps  
  ...
  {64, 12},  // Sound Clip5
  {65, 0}, // Sound Set Channel == LSB 0/1/2
  ...
  {80, 8},  // Sound Clip5
  {81, 1}, // Sound Set Channel == LSB 0/1/2
  ...
  {96, 8},  // Sound Clip5
  {97, 2}, // Sound Set Channel == LSB 0/1/2
  ...
  {112, 0},  // Sound Clip5
  {113, 0}, // Sound Set Channel == LSB 0/1/2
  ...
  {128, 5},  // Sound Clip5
  {129, 1}, // Sound Set Channel == LSB 0/1/2
  ...
  {144, 5},  // Sound Clip5
  {145, 2}, // Sound Set Channel == LSB 0/1/2
  ...
  {160, 5},  // Sound Clip5
  {161, 0}, // Sound Set Channel == LSB 0/1/2
  ...
  {176, 5},  // Sound Clip5
  {177, 1}, // Sound Set Channel == LSB 0/1/2
  ...
  {192, 255},  // Sound Clip5
  {193, 2}, // Sound Set Channel == LSB 0/1/2
  ...
  {208, 0},  // Sound Clip5
  {209, 0}, // Sound Set Channel == LSB 0/1/2
...
void setup()   //******************************************************
{
  ...
  Dcc.init( MAN_ID_DIY, 13, FLAGS_MY_ADDRESS_ONLY, 0 );
  delay(800);
...
void playTrackOnChannel ( byte dtrack, byte dchannel)  {
  switch ( dchannel )  {
    ...
    case 2:
	default:
      if (dtrack!=255) {Player3.play(dtrack); delay(audiocmddelay); }
      else {Player3.play(random(First_Track,Last_Track+1)); delay(audiocmddelay); }
    break;
  }
