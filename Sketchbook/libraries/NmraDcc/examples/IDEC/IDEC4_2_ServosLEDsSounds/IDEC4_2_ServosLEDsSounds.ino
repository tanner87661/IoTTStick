// Switched Pins Servos, LEDs Sounds Variable Slow Servvo Travel   IDEC4_2_ServosLEDsSounds.ino
...
void set_servo (byte servonum, byte position)  {
    ...
    Serial.println(servo_pos[servonum].current_position, DEC) ;
    Serial.print(" target_position: ");
    Serial.println(servo_pos[servonum].target_position, DEC) ;
    Serial.print(" delta: ");
    Serial.println(servo_pos[servonum].delta, DEC) ;
#endif
}
void update_servos()  {
