...
extern void onSensorEvent(uint16_t sensorAddr, uint8_t sensorEvent) __attribute__ ((weak));
extern void onSwitchReportEvent(uint16_t switchAddr, uint8_t switchEvent) __attribute__ ((weak));
