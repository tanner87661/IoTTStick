 ...
 *  This is file for Arduino Micro (ATmega32u4).
 *  IMPORTANT: this was not tested; it is experimentally modified file for Uno! 
 *
...
enum GPIO_pin_enum
{
	...
	DP14 = GPIO_MAKE_PINCODE(MYPORTF,7), // A0
	DP15 = GPIO_MAKE_PINCODE(MYPORTF,6), // A1
	DP16 = GPIO_MAKE_PINCODE(MYPORTF,5), // A2
	DP17 = GPIO_MAKE_PINCODE(MYPORTF,4), // A3
	DP18 = GPIO_MAKE_PINCODE(MYPORTF,1), // A4
	DP19 = GPIO_MAKE_PINCODE(MYPORTF,0), // A5
};
