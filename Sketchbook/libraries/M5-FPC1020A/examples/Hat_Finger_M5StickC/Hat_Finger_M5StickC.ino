...
*                          配套  M5StickC 示例源代码
* Visit for more information: https://docs.m5stack.com/en/hat/hat-finger
* 获取更多资料请访问: https://docs.m5stack.com/zh_CN/hat/hat-finger
*
* Product: Finger Hat example
* Date: 2022/7/18
*******************************************************************************
FINGER Hat use case: Press the left button to enter the fingerprint entry mode.
Press the middle button to enter the fingerprint identification mode FINGER Hat
...
void setup() {
    ...
    M5.Lcd.println("Finger Hat TEST");
