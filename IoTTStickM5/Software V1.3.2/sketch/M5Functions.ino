...
#include "Nickel135240.c"
#include "iottlogo3030.c"
#include "iottlogo6060.c"
#include "iottlogo120120.c"
  ...
  switch (screenDef)
  {
    ...
    case 1:  //Stick C plus
      switch (logoSize)
      {
        ...
        case 1 : M5.Lcd.pushImage( x,y,60,60, (uint16_t *)image_data_iottlogo6060); break;
        case 2 : M5.Lcd.pushImage( x,y,120,120, (uint16_t *)image_data_iottlogo120120); break;
      }
      break;
  }
}
...
void setOpeningPage()
{
  switch (screenDef)
  {
    case 0: 
      ...
      break;
    case 1: 
      M5.Lcd.pushImage( 0,0,240,135, (uint16_t *)image_data_Nickel135240); 
      drawLogo(60, 00, 2); 
      break;
  }
}
