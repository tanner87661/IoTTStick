uint8_t BBVersion[] = {1,2,2}; //release date 4/18/2020
...
//      wifiAlwaysOn =  (!(bool)(*jsonConfigObj)["useWifiTimeout"]);
    ...
    Serial.println(sizeof(useHat.validInterfaces));
    for (int i = 0; i < sizeof(useHat.validInterfaces); i++) // is array of uint8_t
